...
# Index 1: Looked for Apartment in 'PROPERTY' tab
# Index 0: Looked for Toyota in 'VEHICLE' tab
search_history = pd.DataFrame([
    {
        "searchType": "vehicle",
        "filters": {"brand": "Toyota", "propertyType": "any"},
...
print("--- Mock Recommendation Results for Cross-Tab Intents ---")
for r in results:
