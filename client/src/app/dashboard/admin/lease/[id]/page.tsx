        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-background p-4">
                <Card className="max-w-md w-full text-center p-8 border-dashed">
                    ...
                    <Link href="/dashboard/admin?tab=leases">
                        <Button className="w-full bg-[#005a41] hover:bg-[#004a35]">Back to All Leases</Button>
                    </Link>
                </Card>
            </div>
        );
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-xl font-bold text-foreground">Lease Agreement Detail</h1>
                            </div>
                        </div>
                    ...
                    <div className="space-y-8">
                        ...
                        <Card className="border-border shadow-md overflow-hidden ring-1 ring-[#005a41]/5">
                            <CardHeader className="bg-[#005a41] text-white p-6">
                                ...
                                <CardDescription className="text-white/70 text-xs">Overview of involved parties</CardDescription>
                            </CardHeader>
                            <CardContent className="p-6">
                                <div className="space-y-6">
                                    {/* Tenant Details */}
                                    <div>
                                        <p className="text-[10px] uppercase font-bold text-muted-foreground tracking-widest mb-3">Tenant</p>
                                    ...
                                    {/* Owner Details */}
                                    <div>
                                        <p className="text-[10px] uppercase font-bold text-muted-foreground tracking-widest mb-3">Owner / Agent</p>
                                        <div className="flex items-center gap-4 mb-4">
                                            <div className="w-12 h-12 rounded-xl bg-purple-100 flex items-center justify-center font-bold text-purple-700">
