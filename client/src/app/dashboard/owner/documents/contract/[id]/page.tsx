...
export default function OwnerContractPage({ params }: { params: Promise<{ id: string }> }) {
    const { id } = use(params);
                        ...
                        <div className="space-y-12 text-[#1a1a1a] leading-relaxed font-serif text-justify">
                            ...
                            <section className="space-y-4">
                                ...
                                <p>
                                    ...
                                    <span className="font-bold underline px-1">{tenantName}</span> ("Tenant"). Landlord and Tenant are each referred to as a "Party" and collectively as the "Parties."
                                </p>
                            </section>
                            ...
                            <div className="pt-20 grid grid-cols-1 md:grid-cols-2 gap-20">
                                ...
                                <div className="space-y-8">
                                    <div className="h-px bg-black" />
                                    <div>
                                        <p className="font-black text-sm uppercase tracking-widest">{tenantName}</p>
