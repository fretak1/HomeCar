                        ...
                        <div className="space-y-2">
                            ...
                            >
                                ...
                                <SelectContent className="rounded-xl shadow-2xl">
                                    ...
                                    {(searchType === 'property' 
                                        ? [500, 1000, 2500, 5000, 10000, 15000, 20000, 25000, 30000, 40000, 50000, 100000, 500000, 1000000, 5000000, 10000000, 25000000, 50000000] 
                                        : [10000, 15000, 20000, 25000, 30000, 40000, 50000, 100000, 250000, 500000, 1000000, 2500000, 5000000, 10000000, 25000000, 50000000]
                                    ).map(p => (
                        ...
                        <div className="space-y-2">
                            ...
                            >
                                ...
                                <SelectContent className="rounded-xl shadow-2xl">
                                    ...
                                    {(searchType === 'property' 
                                        ? [1000, 5000, 10000, 15000, 20000, 25000, 30000, 40000, 50000, 100000, 500000, 1000000, 5000000, 10000000, 25000000, 50000000, 100000000] 
                                        : [10000, 15000, 20000, 25000, 30000, 40000, 100000, 500000, 1000000, 2500000, 5000000, 10000000, 25000000, 50000000, 100000000]
                                    ).map(p => (
                                        <SelectItem key={p} value={p.toString()}>ETB {p.toLocaleString()}</SelectItem>
                                    ))}
                                </SelectContent>
